...
(() => {
  ...
  // ------------------------------------------------------------
// ------------------------------------------------------------
  // PT-PT / FR / IT: diccionarios completos (todas las claves)
  // ------------------------------------------------------------
  ...
  DICT.pt = {
    ...
    assoc_goal_2:
      "Promover atividades culturais, gastronómicas e académicas que impulsionem o seu conhecimento e valorização social.",
    assoc_goal_3:
    ...
    assoc_goal_7: "Organizar e promover o Concurso Internacional de Doces Conventuais.",
    ...
    assoc_lines_3_text:
      "Atividades culturais e promoção do Concurso Internacional de Doces Conventuais.",
    ...
    assoc_collab_intro:
      "Como entidade cultural, a DULCESOR formaliza colaborações, patrocínios e apoios através de convénios, acordos ou contratos, sem que tais relações confiram a condição de associado.",
    ...
    assoc_collab_4:
      "<strong>Difusão e rede cultural</strong> (media, prescritores, entidades colaboradoras).",
    ...
    contact_collab_text:
      "Se é uma instituição, entidade ou coletivo interessado em apoiar projetos culturais ou atividades, podemos estudar vias de colaboração e participação.",
    contact_collab_btn: "Ver patrocinadores",
    ...
    sponsors_assoc_note: "Esta lista será ampliada progressivamente com novas entidades colaboradoras.",
    sponsors_collab_title: "Quer colaborar?",
    sponsors_collab_text:
      "Se a sua entidade deseja apoiar os projetos culturais da DULCESOR, escreva-nos e informaremos sobre as modalidades de colaboração.",
    ...
    sponsors_spainai_text: "Colaborador tecnológico e cultural na linha de inovação.",
    sponsors_visit_web: "Visitar website",
    ...
    sponsors_private: "Colaboradores",
    sponsors_private_text:
      "Empresas e entidades colaboradoras que tornam possível o desenvolvimento de atividades, comunicação e suporte.",

    // ===== PROYECTOS =====
    projects_page_title: "Projetos · DULCESOR",
    projects_meta_description: "Projetos culturais e gastronómicos da Associação Cultural DULCESOR.",
    ...
    projects_intro_text:
      "Os projetos da Associação Cultural DULCESOR visam valorizar o património doceiro dos conventos e mosteiros, reforçar o vínculo entre gastronomia e cultura e abrir um espaço de colaboração entre artesãs, instituições e cidadania.",
    ...
    projects_featured_project_text:
      "Primeira convocatória internacional impulsionada pela DULCESOR, dedicada a reconhecer e divulgar a doçaria tradicional elaborada em mosteiros e conventos, tendo a cidade de Valladolid como primeiro cenário.",
    ...
    routes_focus_title: "Enfoque cultural",
    routes_focus_text:
      "Este espaço é concebido como uma linha de difusão cultural e patrimonial. Não é um site turístico genérico: privilegia-se um tom institucional, sóbrio e respeitoso, promovendo o conhecimento e a valorização do património monástico e da doçaria artesanal.",
    routes_focus_note:
      "A informação e as listas serão ampliadas progressivamente à medida que avance a atividade da associação.",
    routes_note_title: "Nota",
    routes_note_text:
      "A DULCESOR liga a recursos institucionais ou oficiais quando disponíveis. Este site não comercializa produtos: se uma comunidade tiver venda própria, será ligada ao seu canal oficial.",
    routes_note_pill: "Conteúdo em crescimento",

    museums_title: "Museus conventuais",
    museums_intro:
      "A DULCESOR apoia a conservação e divulgação do património cultural ligado à vida conventual, promovendo os museus conventuais como espaços vivos de memória, arte e tradição.",
    ...
    museum_pill_city_valladolid: "Valladolid",
    museum_santaana_btn_web: "Website oficial do museu",
    museum_santaana_btn_rv: "Experiência virtual (VR) · Em breve",
    museum_santaana_note:
      "Está a ser desenvolvida uma experiência virtual (VR) ligada a peças do museu, que será apresentada em breve.",
    ...
    museum_ursulas_text_3:
      "O Museu de Pintura Medieval de Santa Clara destaca a importância artística deste espaço, dos seus murais, do seu artesonado e da sua musealização.",
    museum_pill_city_salamanca: "Salamanca",
    ...
    routes_morning_note:
      "Estas rotas serão publicadas quando estiverem validadas e apresentarem um enfoque cultural e respeitoso com as comunidades.",

    routes_convents_title: "Conventos e mosteiros",
    routes_convents_text:
      "Ligações diretas para websites oficiais ou canais institucionais de conventos e mosteiros. Quando existirem lojas online ou sistemas de venda próprios, serão ligados para facilitar o acesso aos seus produtos.",
    routes_convents_note:
      "A DULCESOR não comercializa produtos neste site. As ligações conduzem a plataformas externas geridas por cada comunidade ou entidade.",
    ...
    routes_example_2_text:
      "Bloco preparado para incorporar nome, localidade, breve descrição institucional e ligação oficial.",
    routes_example_btn_web: "Website oficial · Em breve",
    ...
    contest_poster_note:
      "O cartaz aparece como imagem oficial do I Concurso Internacional de Doçaria Monástica e Conventual.",
    ...
    contest_trad_p1:
      "Paralelamente ao concurso, desenvolver-se-á um programa de mesas-redondas e encontros de divulgação dedicados à doçaria monástica e artesanal, abordando temas como:",
    ...
    contest_innov_p1:
      "Como experiência cultural e fora de concurso, será elaborada uma sobremesa experimental cuja receita foi desenvolvida mediante inteligência artificial, em colaboração com a associação Spain AI.",
    contest_innov_img_alt: "Imagem associada à inovação",
    contest_innov_p2:
      "Esta iniciativa propõe-se como um exercício de reflexão e diálogo entre tradição e inovação, explorando os limites e possibilidades da criação gastronómica numa perspetiva cultural.",
    ...
    contest_docs_note:
      "Se alguma ligação ainda não estiver publicada, aparecerá marcada como “Em breve”.",

    contest_institutional_title: "Enquadramento institucional",
    contest_institutional_p1:
      "O concurso desenvolve-se com vocação de continuidade e colaboração. A DULCESOR articula relações com instituições culturais e educativas e administrações públicas, bem como com entidades colaboradoras, para reforçar a sua dimensão patrimonial, cultural e de divulgação.",
  ...
  DICT.fr = {
    ...
    home_intro:
      'L’Association culturelle <strong>DULCESOR</strong> œuvre pour la préservation, la diffusion et la mise en valeur de la <strong>pâtisserie monastique et conventuelle</strong> et du patrimoine gastronomique lié aux communautés religieuses, en promouvant des projets culturels d’envergure nationale et internationale.',
    ...
    home_goal_3: "Impulser des projets culturels et gastronomiques à portée internationale.",

    // ===== ASOCIACIÓN =====
    assoc_page_title: "Association · DULCESOR",
    assoc_meta_description:
      "Qui nous sommes et pour quoi nous œuvrons : préserver la pâtisserie monastique-conventuelle et impulser des projets culturels et le Concours international de desserts conventuels.",
    ...
    assoc_identity_p1:
      "L’Association culturelle DULCESOR est une entité à but non lucratif dédiée à la préservation, à la recherche et à la diffusion de la pâtisserie monastique-conventuelle comme patrimoine culturel.",
    assoc_identity_p2:
      "Nous travaillons à valoriser un héritage vivant de recettes, techniques et savoir-faire transmis depuis des siècles, avec respect patrimonial et vocation de coopération.",
    ...
    assoc_goal_2:
      "Promouvoir des activités culturelles, gastronomiques et académiques qui renforcent sa connaissance et sa reconnaissance sociale.",
    assoc_goal_3:
      "Favoriser la recherche, la collecte et la documentation des recettes, techniques et procédés traditionnels.",
    assoc_goal_4:
    ...
    assoc_goal_6: "Impulser des publications et des supports de diffusion contribuant à sa conservation.",
    ...
    assoc_goals_readmore_less: "Réduire",
    ...
    assoc_values_p2:
      "Nous promouvons la reconnaissance de la pâtisserie monastique comme expression culturelle et gastronomique, et comme témoignage vivant de tradition, spiritualité et artisanat.",
    ...
    assoc_collab_intro:
      "En tant qu’entité culturelle, DULCESOR formalise collaborations, parrainages et soutiens par des conventions, accords ou contrats, sans que ces relations n’accordent la qualité de membre.",
    ...
    assoc_collab_3:
      "<strong>Soutien en nature ou services</strong> (espaces, logistique, communication, impression, matériel, etc.).",
    assoc_collab_4:
    ...
    contact_note:
      "Si vous souhaitez collaborer ou obtenir plus d’informations, écrivez-nous et nous vous répondrons dans les meilleurs délais.",
    ...
    // ===== PATROCINADORES =====
    sponsors_page_title: "Sponsors · DULCESOR",
    sponsors_meta_description: "Sponsors et collaborateurs de l’Association culturelle DULCESOR.",
    sponsors_title: "Sponsors",
    ...
    sponsors_assoc_note: "Cette liste s’élargira progressivement avec de nouvelles entités partenaires.",
    sponsors_collab_title: "Vous souhaitez collaborer ?",
    sponsors_collab_text:
      "Si votre entité souhaite soutenir les projets culturels de DULCESOR, écrivez-nous et nous vous informerons des modalités de collaboration.",
    ...
    sponsors_spainai_text: "Partenaire technologique et culturel dans la ligne d’innovation.",
    sponsors_visit_web: "Visiter le site",
    sponsors_cta: "Proposer un parrainage",
    sponsors_institutional: "Institutionnels",
    sponsors_institutional_text:
      "Entités publiques et institutions qui soutiennent le projet culturel et le concours.",
    ...
    projects_meta_description: "Projets culturels et gastronomiques de l’Association culturelle DULCESOR.",
    ...
    projects_intro_text:
      "Les projets de l’Association culturelle DULCESOR visent à mettre en valeur le patrimoine pâtissier des couvents et monastères, renforcer le lien entre gastronomie et culture, et ouvrir un espace de collaboration entre artisanes, institutions et citoyenneté.",
    ...
    projects_line_2:
      "Développement d’itinéraires et de rencontres culturelles pour promouvoir la visite de monastères et musées liés à la tradition pâtissière.",
    projects_line_3:
    ...
    routes_meta_description: "Itinéraires monastiques et musées conventuels : ligne culturelle de DULCESOR.",
    ...
    routes_focus_text:
      "Cet espace est conçu comme une ligne de diffusion culturelle et patrimoniale. Ce n’est pas un site touristique générique : nous privilégions un ton institutionnel, sobre et respectueux, en promouvant la connaissance et la mise en valeur du patrimoine monastique et de la pâtisserie artisanale.",
    routes_focus_note:
      "Les informations et les listes s’enrichiront progressivement au fur et à mesure de l’activité de l’association.",
    routes_note_title: "Note",
    routes_note_text:
      "DULCESOR renvoie vers des ressources institutionnelles ou officielles lorsqu’elles sont disponibles. Ce site ne commercialise pas de produits : si une communauté dispose d’un canal de vente propre, un lien vers son canal officiel sera proposé.",
    ...
    museum_ursulas_text_2:
      "Le Monastère de l’Annonciation, connu populairement comme « las Úrsulas », est l’un des ensembles religieux les plus intéressants de la ville de Salamanque et, depuis 1931, Monument historique national.",
    museum_ursulas_text_3:
      "Le Musée de peinture médiévale de Sainte Claire met en évidence l’importance artistique de cet espace, de ses peintures murales, de son plafond à caissons et de sa muséographie.",
    ...
    museums_other_note:
      "Cette section s’enrichira en intégrant d’autres musées conventuels partageant les valeurs culturelles et patrimoniales de DULCESOR.",

    routes_morning_title: "Itinéraires d’une matinée",
    routes_morning_text:
      "Nous préparerons de petits itinéraires culturels (matinée ou demi-journée) pour visiter trois ou quatre monastères, musées ou sites patrimoniaux, avec la possibilité de renvoyer vers l’achat de produits si la communauté dispose de canaux officiels.",
    routes_morning_note:
      "Ces itinéraires seront publiés lorsqu’ils seront vérifiés et présenteront une approche culturelle et respectueuse des communautés.",
    ...
    routes_example_1_text:
      "Bloc prêt à intégrer le nom, la localité, une brève description institutionnelle et un lien officiel.",
    ...
    contest_presentation_p1:
      "Le concours naît avec une vocation culturelle et internationale pour reconnaître et mettre en valeur la pâtisserie monastique comme héritage historique et expression d’artisanat. Il réunit communautés, institutions et citoyenneté autour d’un programme combinant élaboration, diffusion et rencontre.",
    contest_presentation_note:
      "(Les informations détaillées de participation, critères et calendrier seront incluses dans les bases officielles).",

    contest_section_title: "Le concours",
    contest_section_subtitle: "Élaboration et évaluation",
    contest_section_li1: "Élaboration : jeudi 1er octobre (École internationale de cuisine).",
    contest_section_li2: "Remise des prix (après-midi) : chapelle du Couvent de Santa Ana.",
    contest_section_li3: "Note : détails complets dans les bases.",

    contest_craft_kicker: "Artisanat / Faire",
    contest_craft_img_alt: "Mains pétrissant une pâte",
    ...
    contest_trad_p1:
      "En parallèle du concours, un programme de tables rondes et de rencontres de diffusion dédiées à la pâtisserie monastique et artisanale sera développé, abordant des questions telles que :",
    ...
    contest_innov_p1:
      "Comme expérience culturelle et hors concours, un dessert expérimental sera élaboré, dont la recette a été développée au moyen de l’intelligence artificielle, en collaboration avec l’association Spain AI.",
    ...
    contest_reg_p1:
      "L’appel initial est en préparation. Cette section publiera les bases et la documentation officielle pour participer.",

    contest_docs_title: "Documentation officielle",
    contest_docs_bases_soon: "Bases (PDF) · Bientôt",
    ...
    contest_institutional_p1:
      "Le concours se développe avec une vocation de continuité et de collaboration. DULCESOR articule des relations avec des institutions culturelles et éducatives et des administrations publiques, ainsi qu’avec des entités partenaires, afin de renforcer sa dimension patrimoniale, culturelle et de diffusion.",
  ...
  DICT.it = {
    ...
    home_intro:
      'L’Associazione culturale <strong>DULCESOR</strong> promuove la preservazione, la diffusione e la valorizzazione della <strong>pasticceria monastica e conventuale</strong> e del patrimonio gastronomico legato alle comunità religiose, promuovendo progetti culturali di portata nazionale e internazionale.',
    ...
    assoc_identity_p2:
      "Lavoriamo per valorizzare un’eredità viva di ricette, tecniche e saperi tramandati per secoli, con rispetto patrimoniale e vocazione collaborativa.",
    ...
    assoc_goal_3:
      "Incoraggiare ricerca, raccolta e documentazione di ricette, tecniche e processi tradizionali.",
    assoc_goal_4:
    ...
    assoc_goal_6: "Promuovere pubblicazioni e materiali divulgativi che contribuiscano alla conservazione.",
    ...
    // ===== CONTACTO =====
    contact_page_title: "Contatto · DULCESOR",
    ...
    contact_note:
      "Se desideri collaborare o richiedere maggiori informazioni, scrivici e ti risponderemo il prima possibile.",
    ...
    sponsors_assoc_note: "Questo elenco si amplierà progressivamente con nuovi enti collaboratori.",
    sponsors_collab_title: "Vuoi collaborare?",
    sponsors_collab_text:
      "Se il tuo ente desidera sostenere i progetti culturali di DULCESOR, scrivici e ti informeremo sulle modalità di collaborazione.",
    sponsors_collab_btn: "Vai al contatto",
    ...
    projects_meta_description: "Progetti culturali e gastronomici dell’Associazione culturale DULCESOR.",
    projects_title: "Progetti",
    projects_subtitle:
      "Iniziative culturali e gastronomiche dedicate alla conservazione e diffusione della pasticceria monastica e conventuale.",
    ...
    projects_line_3:
      "Edizione di materiali divulgativi ed educativi su storia, tecniche e patrimonio dolciario.",
    ...
    projects_featured_project_text:
      "Prima convocazione internazionale promossa da DULCESOR, dedicata a riconoscere e diffondere la pasticceria tradizionale realizzata in monasteri e conventi, con la città di Valladolid come primo scenario.",
    projects_featured_more: "Vedi di più sui concorsi",
    projects_future_title: "Progetti futuri",
    projects_future_text:
      "Attualmente l’Associazione culturale DULCESOR lavora alla progettazione di nuove iniziative legate alla ricerca e alla divulgazione del patrimonio conventuale, nonché alla creazione di alleanze internazionali che rafforzino la diffusione culturale e gastronomica di questo patrimonio dolciario.",
    projects_future_note:
    ...
    routes_focus_text:
      "Questo spazio è concepito come una linea di diffusione culturale e patrimoniale. Non è un sito turistico generico: si privilegia un tono istituzionale, sobrio e rispettoso, promuovendo la conoscenza e la valorizzazione del patrimonio monastico e della pasticceria artigianale.",
    routes_focus_note:
      "Le informazioni e gli elenchi si amplieranno progressivamente con l’avanzare dell’attività dell’associazione.",
    routes_note_title: "Nota",
    routes_note_text:
      "DULCESOR rimanda a risorse istituzionali o ufficiali quando disponibili. Questo sito non commercializza prodotti: se una comunità dispone di un proprio canale di vendita, verrà indicato il canale ufficiale.",
    ...
    museum_santaana_text:
      "Museo di arte sacra barocca nel monastero cistercense, con un insieme patrimoniale di grande rilievo. Spazio legato all’identità culturale di DULCESOR.",
    museum_pill_priority: "Prioritario",
    ...
    museum_santaana_note:
      "È in fase di sviluppo un’esperienza in realtà virtuale (VR) legata a opere del museo, che sarà presentata prossimamente.",
    ...
    museum_ursulas_text_2:
      "Il Monastero dell’Annunciazione, noto popolarmente come “las Úrsulas”, è uno dei complessi religiosi più interessanti della città di Salamanca e dal 1931 Monumento Storico Nazionale.",
    museum_ursulas_text_3:
      "Il Museo di Pittura Medievale di Santa Clara mette in luce l’importanza artistica di questo spazio, dei suoi murales, del suo soffitto a cassettoni e della sua musealizzazione.",
    museum_pill_city_salamanca: "Salamanca",
    ...
    museums_other_1_text:
      "Spazio monastico di notevole valore storico e patrimoniale. Questo blocco è pronto per essere completato con informazioni istituzionali e link ufficiale.",
    museums_other_2_title: "Convento di San Francesco (Medina de Rioseco) · Patrimonio sacro",
    museums_other_2_text:
    ...
    routes_morning_text:
      "Prepareremo piccoli percorsi culturali (mattina o mezza giornata) per visitare tre o quattro monasteri, musei o siti patrimoniali, con la possibilità di collegare l’acquisto di prodotti se la comunità dispone di canali ufficiali.",
    routes_morning_note:
    ...
    contest_poster_kicker: "Poster ufficiale del concorso",
    contest_poster_alt: "Poster ufficiale del concorso",
    contest_poster_note:
      "Il poster appare come immagine ufficiale del I Concorso Internazionale di Pasticceria Monastica e Conventuale.",
    ...
    contest_section_li2: "Premiazione (pomeriggio): Cappella del Convento di Santa Ana.",
    ...
    contest_trad_p1:
      "Parallelamente al concorso, si svilupperà un programma di tavole rotonde e incontri divulgativi dedicati alla pasticceria monastica e artigianale, affrontando temi quali:",
    ...
    contest_innov_p1:
      "Come esperienza culturale e fuori concorso, verrà realizzato un dessert sperimentale la cui ricetta è stata sviluppata mediante intelligenza artificiale, in collaborazione con l’associazione Spain AI.",
    contest_innov_img_alt: "Immagine associata all’innovazione",
    contest_innov_p2:
      "Questa iniziativa si propone come esercizio di riflessione e dialogo tra tradizione e innovazione, esplorando limiti e possibilità della creazione gastronomica in una prospettiva culturale.",
    contest_badge_out: "Fuori concorso",

    contest_reg_title: "ISCRIZIONE · Convocatoria iniziale",
    contest_reg_status_label: "Stato:",
    contest_reg_status_value: "in preparazione",
    contest_reg_p1:
      "La convocatoria iniziale è in preparazione. In questa sezione saranno pubblicati il regolamento e la documentazione ufficiale per partecipare.",
    ...
    contest_institutional_p1:
      "Il concorso si sviluppa con vocazione di continuità e collaborazione. DULCESOR articola relazioni con istituzioni culturali ed educative e con le amministrazioni pubbliche, così come con enti collaboratori, per rafforzarne la dimensione patrimoniale, culturale e divulgativa.",

    contest_sponsors_title: "Sponsor del concorso",
    contest_sponsors_note: "Loghi istituzionali e collaboratori (cartella: assets/logos/)."
  };
